 ...
 *
 * □プレイヤーにアニメーション表示
 * animation player アニメーションID 反転表示フラグ 遅延フレーム 拡大率(%) 角度 x軸のずれ y軸のずれ 効果音の音量
 *
 * □実行中のイベントにアニメーション表示
 * animation this アニメーションID 反転表示フラグ 遅延フレーム 拡大率(%) 角度 x軸のずれ y軸のずれ 効果音の音量
 *
 * □マップ上のイベントにアニメーション表示 
 * animation event イベントID アニメーションID 反転表示フラグ 遅延フレーム 拡大率(%) 角度 x軸のずれ y軸のずれ 効果音の音量
 *
 * □戦闘中の敵にアニメーション表示
 * animation enemy 敵のインデックス アニメーションID 反転表示フラグ 遅延フレーム 拡大率(%) 角度 x軸のずれ y軸のずれ 効果音の音量
 *
 * □戦闘中のパーティーメンバーにアニメーション表示（サイドビュー時） 
 * animation party パーティーメンバーのインデックス アニメーションID 反転表示フラグ 遅延フレーム 拡大率(%) 角度 x軸のずれ y軸のずれ 効果音の音量
 *
 * □戦闘中のアクターにアニメーション表示（サイドビュー時） 
 * animation actor アクターID アニメーションID 反転表示フラグ 遅延フレーム 拡大率(%) 角度 x軸のずれ y軸のずれ 効果音の音量
 *
 *
 * 【パラメータ解説】
 ...
 *
 * 【プラグインコマンド例】
 * animation event 1 2 true 0 50 90 20 30 40
 *   イベントID１のイベントに
 *   アニメーションID2のアニメーションを
 *   左右反転して
 *   表示遅延０で
